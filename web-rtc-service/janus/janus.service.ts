...
class JanusService  {
                        ...
                        onmessage: (msg, jsep) => {
                            ...
                            if (event !== undefined && event !== null) {
                                if (event === "joined") {// Publisher/manager created, negotiate WebRTC and attach to existing feeds, if any
                                    ...
                                    eventHub.trigger(events.USER_SET, { id: msg["id"],displayName,roomName:roomNumber });
                                    eventHub.trigger(events.PARTICIPANT_JOINED, { id: msg["id"], displayName })
                                    this.id = msg["id"]
                                    ...
                                    if (msg["publishers"] !== undefined && msg["publishers"] !== null) {
                                        ...
                                        eventHub.trigger(events.PARTICIPANT_LEFT, leaving)
                                        let remoteFeed = null;
                                        ...
                                        eventHub.trigger(events.PARTICIPANT_LEFT, unpublished)
    ...
    attachFeed = (list) => {
        ...
        for (let f in list) {
            ...
            eventHub.trigger(events.PARTICIPANT_JOINED, { id, displayName })
    ...
    newRemoteFeed = (id, display, roomNumber) => {
        ...
        this.rtcInstence.attach({
            ...
            ondata: function (data) {
                console.log(data);
                eventHub.trigger(events.MESSAGE_RECEIVED, JSON.parse(data));
            },
